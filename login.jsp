...
<head>
  ...
  <title>Login - QADSS</title>  <link rel="stylesheet" href="${pageContext.request.contextPath}/static/css/style.css">
</head>
  ...
  <div class="max-w-md w-full bg-white p-8 rounded shadow">
    ...
    <form action="/login" method="post" onsubmit="return validateLogin()">
      ...
      <div class="mb-4">
        ...
        <input id="password" name="password" type="password" class="w-full border p-2 rounded" required />
      </div>
